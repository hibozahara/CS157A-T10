...
<%@ page
	import="model.Donation, dao.DonationDAO, model.User, dao.UserDao, model.Request, dao.RequestDao, java.util.*"%>
		...
		<div class="row">
			<div class="card">
				<div class="container">
					...
					<div class="cardElements" style="text-align: center">Contact
						Information: ${ l.getContact() }</div>
					...
					<div class="text-center">
						<button type="submit" class="button1">${ l.getStatus() }</button>
					</div>
				</div>
			</div>
		</div>
